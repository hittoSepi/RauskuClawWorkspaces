...
- [ ] Open SFTP tab after VM start; verify initial listing.
- [ ] Upload test file and confirm it appears in listing.
- [ ] Download same file and verify local contents.
- [ ] Create/rename/delete test folder.
- [ ] Stop VM while tab open; verify UI updates to disconnected state.
- [ ] Start VM again; verify reconnect and refresh works.
